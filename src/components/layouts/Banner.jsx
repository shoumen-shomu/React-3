  ...
  return (
    <div className="bg-[url('/src/assets/banner.jpg')] py-[300px] bg-center bg-cover bg-no-repeat">
      <Container>
        ...
        />
        <Button className={"py-[14px] px-[24px] rounded-[100px] bg-[#FF7628] font-sans font-bold text-[18px] text-white mt-[30px] py-[20px] px-[40px] font-bold text-[20px] leading-[24px] uppercase "} btnText={"get free quoto"}/>
      </Container>
    </div>
  );
};
